  ...
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center z-50 transition-opacity duration-300 ease-in-out">
      <div className="bg-white rounded-lg p-6 sm:w-1/3 shadow-xl transform transition-all duration-300 ease-in-out scale-95 hover:scale-100">
        <img src={LogoutIllustration} className="" alt="logoutIllustration" />
        ...
        <div className="flex justify-center gap-8 space-x-6 text-sm xl:text-base">
          <button
            onClick={onClose}
            className="bg-gray-300 text-gray-800 py-2 px-5 rounded-md hover:bg-gray-400 transition-all duration-200"
          >
            Cancel
          </button>
          <button
            ...
            className="bg-red-600 text-white py-2 px-5 rounded-md hover:bg-red-700 transition-all duration-200 flex items-center space-x-2"
          >
            {/* Logout SVG Icon */}
