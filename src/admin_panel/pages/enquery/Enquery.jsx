    ...
    <div className="h-screen w-full bg-gray-100 p-6 overflow-y-auto scrollbar">
      ...
      <div className="mx-auto p-6 pt-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div
            onClick={() => {
              setMessage(totalInqueris);
              setMode("total");
            }}
            className="bg-white cursor-pointer p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300"
          >
            <div className="flex items-center justify-between">
              ...
              <div className="p-3 bg-indigo-500 text-white rounded-full">
                ...
                >
                  ...
                  <path
                    fill="currentColor"
                    d="M12 8V2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V10h-6a2 2 0 0 1-2-2m-3.75 3.5h7.5a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1 0-1.5m0 2.75h7.5a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1 0-1.5m0 2.75h7.5a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1 0-1.5m5.25-9V2.5l6 6H14a.5.5 0 0 1-.5-.5"
                  />
                </svg>
              </div>
            </div>
            <div className="mt-4 text-3xl font-bold text-indigo-600">
              {totalInqueris.length}
            </div>
            <p className="text-sm py-2 bg-gray-200/50 text-center text-gray-500 mt-2">
              Total number of inquiries received to date.
            </p>
          </div>
          ...
          >
            ...
            <div className="mt-4 text-3xl font-bold text-yellow-600">
              {panddingInquress.length}
            </div>
            <p className="text-sm py-2 bg-gray-200/50 text-center text-gray-500 mt-2">
              Inquiries waiting to be addressed.
            </p>
          </div>
        </div>
      </div>
                  ...
                  {Messages.length > 0 ? (
                    Messages.map((inquiry, index) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-3 w-60 text-wrap">
                          {inquiry.Subject}
                        </td>
