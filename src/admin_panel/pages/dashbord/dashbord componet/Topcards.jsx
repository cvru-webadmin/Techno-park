...
export default function Topcards({isTime, events, feedbacks, Inqueris}) {
  ...
  const cards = [
    {
      ...
      iconBgColor:"#F59E0B",
      subline:"Feedback entries received.",
    },
    {
      title: "Total Events",
    ...
    },
    {
      ...
      total: Inqueris.length,
      iconBgColor:"#6366F1",
      subline:"Received inquiries count.",
    },
    {
      title: "Faculty",
      icon: <svg xmlns="http://www.w3.org/2000/svg" className='h-7' viewBox="0 0 24 24">
    ...
    <div className=" bg-gray-50 p-6">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {cards.map((card, index) => (
          <div
            key={index}
            className=" rounded-lg shadow-md py-2 px-2  border-gray-300/50 transition-all duration-300"
          >
            <div className="flex justify-between border-2 border-gray-300/50 rounded-lg px-2 py-4 bg-white items-center">
              ...
              <div className="w-2/3">
                ...
                <p className="text-sm text-gray-500">{card.subline}</p>
              </div>
            </div>
            <div className="py-2">
