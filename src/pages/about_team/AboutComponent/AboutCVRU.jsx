    ...
    <div className="w-full bg-gray-50 rounded-lg p-8 flex flex-col lg:flex-row lg:justify-evenly">
      ...
      <div className="lg:w-[50%] lg:mt-0 mt-4 w-full mr-[2.5%]">
        ...
        <p className="about-description">
          Dr. C.V. Raman University (Khandwa), the fifth under the AISECT Group
          of Universities, is located in Madhya Pradesh's Nimar region. The
          university offers exceptional infrastructure, skilled faculty, and
          industry-focused education, blending academic knowledge with practical
          skills. Through its AISECT-NSDC partnership, it provides
          NSDC-certified courses, enhancing employability, while its online
          placement platform, <strong>Rojgar Mantra</strong>, connects students
          to top employers.
        </p>
        <p className="about-description">
          CVRU Khandwa focuses on holistic development, offering modern
          facilities, comprehensive programs, and opportunities for students to
          excel academically and professionally. The university is committed to
          empowering the region's youth with quality education and skill
          development.
        </p>
