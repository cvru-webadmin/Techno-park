...
function HomePage() {
  return (
    <div className="overflow-hidden">
      ...
      <div className="bg-gray-800 bg-opacity-90 text-white py-20 px-8 lg:px-28 text-center backdrop-blur-md">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between mb-16">
          ...
          <div className="mb-6 lg:mb-0 lg:mr-12 ">
            <img
              src={CvruLogo}
              alt="University Logo"
              className="w-28 h-28 bg-white md:w-32 md:h-32 lg:w-11/12 p-3 rounded-lg shadow-xl object-scale-down mx-auto lg:mx-0 border border-gray-300"
            />
          </div>

          {/* Department Name and Sub-name */}
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-wide uppercase text-teal-400">
              Techno Park
            </h1>
            <p className="text-lg md:text-xl lg:text-2xl font-medium text-gray-300 mt-2 lg:mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-left">
          {/* University Section */}
          <div className="bg-gray-700 p-8 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out">
            <h3 className="text-xl font-semibold mb-4 text-teal-300">About the University</h3>
          ...
          {/* Department Section */}
          <div className="bg-gray-700 p-8 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out">
            <h3 className="text-xl font-semibold mb-4 text-teal-300">About the Department</h3>
            <p className="text-sm md:text-base font-light leading-relaxed text-gray-200">
          ...
          <div className="bg-gray-700 p-8 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out">
            <h3 className="text-xl font-semibold mb-4 text-teal-300">Tech Placements & Future</h3>
            <p className="text-sm md:text-base font-light leading-relaxed text-gray-200">
